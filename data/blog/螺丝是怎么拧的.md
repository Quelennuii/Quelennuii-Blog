...
tailwind 的 class 是有顺序的，找不到复制搜

## npm 包

在 util 里调用函数是可以被执行的，都得判断项目环境再搞
...
localstorage 会跨域，searchURLParams 可以获取 url 里？后面的东西
...
读文件用 node 的 fs 读，写也是

如果文字回车了，不仅会/n，还会 /n ，正则不好写
